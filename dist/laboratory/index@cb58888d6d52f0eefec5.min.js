...
eval("var $imports = __webpack_require__(/*! ../../../node_modules/art-template/lib/runtime.js */ \"./node_modules/art-template/lib/runtime.js\");\nmodule.exports = function ($data) {\n    'use strict';\n    $data = $data || {};\n    var $$out = '', $$blocks = arguments[1] || {}, include = function (content) {\n            $$out += content;\n            return $$out;\n        }, title = $data.title;\n    include(__webpack_require__(/*! ./header.art */ \"./src/pages/home/header.art\")({ title: title }));\n    $$out += '\\r\\n\\r\\n<p><img ';\n    $$out += 'src=\"' + __webpack_require__(/*! ./drink.png */ \"./src/pages/home/drink.png\") + '\"';\n    $$out += ' alt=\"timg\" /></p>\\r\\n<p>This is just an awesome page.</p>\\r\\n';\n    include(__webpack_require__(/*! ./footer.art */ \"./src/pages/home/footer.art\")($data));\n    $$out += '\\r\\n';\n    return $$out;\n};\n\n//# sourceURL=webpack:///./src/pages/home/index.art?");
